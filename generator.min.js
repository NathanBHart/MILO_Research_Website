document.addEventListener("DOMContentLoaded", function () {
    ...
    if (techData.applications.length >= 1 && techData.applications[0] !== "") {
    ...
    let techAdvantages = "";
    if (techData.advantages.length >= 1 && techData.advantages[0] !== "") {
        let advantagesList = "";
    ...
    let techReferences = "";
    if (techData.references.length >= 1 && techData.references[0] !== "") {
        let referencesList = "";
