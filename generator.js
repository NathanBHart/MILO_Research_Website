document.addEventListener("DOMContentLoaded", function () {
    ...
    let techHTML = `<div class="container"><div class="row"><div class="col-12"><div class="row"><div class="col-md-12 align-self-center my-3"><div class="container"><div class="technology"><div class="row flex-row-reverse"><div class="col-lg-8 pl-lg-5 my-auto technology-title">${techTitle}${techExecutiveSummary}</div><div class="col-lg-4">${techFigure}</div></div><div class="technology-body"><div class="row"><div class="col-lg-4 technology-sidebar"><div class="tech-id text-white"><h4 class="mb-2 text-white" style="font-size: x-large;">Tech ID:</h4><p id="tech-id" class="text-white" style="font-size: larger;">${techId}</p></div><div class="sidebar-info">${techInventors}${techResearchStage}${techPatentStatus}${techContactBlock}</div></div><div class="col-lg-8 pl-lg-5">${techAbstract}${techApplications}${techAdvantages}${techReferences}</div></div></div></div></div></div></div></div></div></div>`;
