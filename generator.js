document.addEventListener("DOMContentLoaded", function () {
    ...
    let techHTML = `<div class="container"><div class="row"><div class="col-12"><div class="row"><div class="col-md-12 align-self-center my-3"><div class="container"><div class="technology"><div class="row flex-row-reverse"><div class="col-lg-8 pl-lg-5 my-auto pb-5 technology-title">${techTitle}${techExecutiveSummary}</div><div class="col-lg-4">${techFigure}</div></div><hr class="mb-5"><div class="technology-body"><div class="row"><div class="col-lg-4 technology-sidebar"><div class="tech-id text-white"><div class="row align-items-center"><div class="col-4"><h4 style="font-size: x-large;" class="text-white">Tech ID:</h4></div><div class="col-8"><p id="tech-id" class="text-white" style="font-size: x-large;font-weight: 800;text-align: right;">${techId}</p></div></div></div><div class="sidebar-info">${techInventors}${techResearchStage}${techPatentStatus}${techContactBlock}</div></div><div class="col-lg-8 pl-lg-5">${techAbstract}${techApplications}${techAdvantages}${techReferences}</div></div></div></div></div></div></div></div></div></div>`;
